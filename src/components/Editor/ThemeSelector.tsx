  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-0.5 shrink-0">
        <div
          className="w-4 h-4 rounded-l-md border border-slate-200 dark:border-slate-600"
          style={{ backgroundColor: theme.colors.background }}
        />
        <div
          className="w-4 h-4 border-y border-slate-200 dark:border-slate-600"
        ...
        />
        <div
          className="w-4 h-4 rounded-r-md border border-slate-200 dark:border-slate-600"
