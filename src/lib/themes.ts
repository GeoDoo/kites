...
export const themes: Record<string, KiteTheme> = {
  ...
  rpg: {
    id: "rpg",
    name: "RPG Fantasy",
    description: "Dark fantasy atmosphere",
    colors: {
      background: "#1a1428",
      surface: "rgba(30, 22, 50, 0.75)",
      text: "#d4c8a8",
      textMuted: "#a89878",
      accent: "#4fc3f7",
      accentText: "#ffffff",
      heading: "#e8dcc0",
      headingShadow: "0 0 12px rgba(79, 195, 247, 0.4), 2px 2px 4px rgba(0,0,0,0.8)",
    },
