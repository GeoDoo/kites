...
export const TALK_KITES: KiteDef[] = [
  ...
  },
  {
    ...
    {
      type: "h2",
      content: `4 existential threats...<div>20 disasters...<br>15+ years of engineering experience, and...<div>1003 failed applications later...</div></div>`,
  ...
  },
  {
    ...
    {
      type: "text",
      content: `<ul><li>Systems thinking</li><li>Problem decomposition</li><li>Simplification</li></ul>`,
      position: { x: 5, y: 22, width: 88, height: 45 },
      style: { fontSize: 28, textAlign: "left" },
      zIndex: 10,
    },
  ...
  },
  {
    ...
    {
      type: "h2",
      content: "The Meteorite Scenario",
      position: { x: 5, y: 15, width: 90, height: 22 },
      style: { fontSize: 48, fontWeight: "bold", textAlign: "center" },
      zIndex: 10,
    },
